  ...
  return (
    <Fragment>
      ...
      <section className="mx-auto max-w-full lg:max-w-[92%] mb-8 p-2">
        ...
        <section className="grid grid-cols-3 gap-3 border">
          {components.map((item: Components) => {
              return (
                <section key={item.title} className="col-span-3 w-full lg:col-span-1 flex bg-slate-200 rounded-md w-96 shadow">
                  ...
                  <section className="basis-[60%] p-2">
                    ...
                    <Button
                      variant="outline"
                      className="bg-slate-300 text-slate-800 text-[.8rem] hover:bg-slate-300 cursor-pointer mt-3"
                      asChild
                    >
