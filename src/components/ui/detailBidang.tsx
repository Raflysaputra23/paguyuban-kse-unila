    ...
    <Fragment>
      <section className="mx-auto max-w-full lg:max-w-[92%] p-2 mb-8 mt-4 border">
        ...
        <section className="my-6 mx-auto flex flex-col justify-center items-center gap-3">
          ...
          />
          <h1 data-aos="fade-up" data-aos-delay="200" className="font-bold">{item.title}</h1>
        </section>
      </section>
      <section className="mx-auto max-w-full lg:max-w-[92%] p-2">
        ...
        <section data-aos="fade-right" data-aos-delay="100" className=" bg-slate-50 p-4 shadow-md rounded-md">
          <p>{item.description}</p>
        </section>
      </section>
      <section className="mx-auto max-w-full lg:max-w-[92%] p-2 mb-4">
        <h1 data-aos="fade-right" data-aos-delay="200" className="text-sm px-3 py-2 rounded-md shadow inline-block mb-2 bg-slate-50">
          Progja
        </h1>
        <section className="flex flex-col items-start gap-3">
          {item?.progja &&
            item.progja.map((progja: string) => (
              <section data-aos="fade-right" data-aos-delay={delay += 100} key={progja} className="flex items-center gap-2 text-sm">
